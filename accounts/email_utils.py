...
class AuthEmailService:
    ...
    def send_password_reset_otp(user, otp):
        """
        🔑 Send password reset OTP (6-digit code, expires in 10 minutes)
        
        WHY: Allow users to securely reset forgotten passwords using OTP
        WHEN: User requests password reset
        HOW: Send OTP code via email for verification
        """
        try:
