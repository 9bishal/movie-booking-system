"""
Management command to verify email for admin and staff users.
Ensures all superusers and staff have verified email profiles.
"""
    ...
    def handle(self, *args, **options):
        ...
        for user in admin_users:
            try:
                ...
                # Create verified profile for admin/staff
