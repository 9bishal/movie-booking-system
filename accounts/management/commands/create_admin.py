"""
Management command to create or reset admin/superuser accounts.
Ensures admin users have proper staff status, superuser permissions, and verified email.

Usage:
    python manage.py create_admin --username admin --email admin@example.com --password adminpass
    python manage.py create_admin --reset  # Reset existing admin user
"""
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if user and reset:
                ...
                # Create or get verified profile
