"""
Management command to remove duplicate users by email address.
Keeps the most recently created user for each email.
"""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Find emails that have duplicates (excluding empty emails)
        duplicate_emails = (
