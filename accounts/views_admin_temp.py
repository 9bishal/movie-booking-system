"""
Quick admin setup view - temporary endpoint to make user admin
Add to urls.py temporarily, then remove after use
"""
...
def make_admin_temp(request):
    ...
    # Security check - only works if DEBUG=True or from localhost
